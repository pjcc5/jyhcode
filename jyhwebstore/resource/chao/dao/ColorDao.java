...
public interface ColorDao {
	...
	public Color getColorById(int comid,Connection conn) throws Exception;//通过获得一个颜色
	public boolean insertColor(Color color,Connection conn)throws Exception;//插入颜色的方法
	public boolean deleteColorByid(int comid,Connection conn) throws Exception;//删除颜色的方法
