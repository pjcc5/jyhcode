...
public interface UserDao {
	...
	public User getUserById(int uid,Connection conn)throws Exception;//通过uid获得一个用户
	public boolean insertUser(User user,Connection conn)throws Exception;//插入用户的方法
	public boolean deleteUserByid(int uid,Connection conn)throws Exception;//删除用户的方法
